...
import os
import smtplib
import jokes  # pip install jokes
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login("chaliahmed745@gmail.com", "aliahmed88")
    server.sendmail("chaliahmed745@gmail.com", to, content)
    server.close()
